...
// *** commented out  because I did not need it
// const appointmentData = require("../SampleData/appointmentData.js"); // Importing the data

// const appointmentData = require('../SampleData/appointmentData.js');

// Render the form to list all appointments- not necessary for dealing with json data
...
// const getAppointments = async (req, res) => {
//     // console.log("getting appointment notice");
//   try {
//       const appointments = await Appointment.find({});
//       res.json(appointments);
//   } catch (error) {
